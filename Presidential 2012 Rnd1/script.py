#download the 2012 egypt elections results from the official website 
# http://presidential2012.elections.eg/index.php/round1-results has the results in both csv and xls formats but it doesn't show 
...
source_url = "http://egelections-2011.appspot.com/Presidential2012/results1/index.html"
...
for option in districts :
	...
	#linux command
	csv_command="wget -P csv http://egelections-2011.appspot.com/Presidential2012/results1/csv/"+ option.get('value') + ".csv" 
        excel_command="wget -P xls http://egelections-2011.appspot.com/Presidential2012/results1/excels/"+ option.get('value') + ".xls" 
