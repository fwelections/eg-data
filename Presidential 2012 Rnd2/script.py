...
# http://presidential2012.elections.eg/index.php/round2-results has the results in both csv and xls formats but it doesn't show 
...
source_url = "http://egelections-2011.appspot.com/Presidential2012/results/index.html"
...
for option in districts :
	...
	#linux command
	csv_command="wget -P csv http://egelections-2011.appspot.com/Presidential2012/results/csv/"+ option.get('value') + ".csv" 
        excel_command="wget -P xls http://egelections-2011.appspot.com/Presidential2012/results/excels/"+ option.get('value') + ".xls" 
